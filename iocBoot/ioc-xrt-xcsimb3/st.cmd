...
dbLoadRecords( "db/ipimb.db, "RECNAME=HFX:DG2:IMB:01,BOX=HFX-DG2-IMB-01,CH0=HFX:DG2:IMB:01:CH0,CH1=HFX:DG2:IMB:01:CH1,CH2=HFX:DG2:IMB:01:CH2,CH3=HFX:DG2:IMB:01:CH3")
dbLoadRecords( "db/ipimb.db, "RECNAME=HFX:DG2:IMB:02,BOX=HFX-DG2-IMB-02,CH0=HFX:DG2:IMB:02:CH0,CH1=HFX:DG2:IMB:02:CH1,CH2=HFX:DG2:IMB:02:CH2,CH3=HFX:DG2:IMB:02:CH3")
dbLoadRecords( "db/ipimb.db, "RECNAME=XCS:DG3:IMB:03,BOX=XCS-DG3-IMB-03,CH0=XCS:DG3:IMB:03:CH0,CH1=XCS:DG3:IMB:03:CH1,CH2=XCS:DG3:IMB:03:CH2,CH3=XCS:DG3:IMB:03:CH3")
dbLoadRecords( "db/ipimb.db, "RECNAME=XCS:DG3:IMB:04,BOX=XCS-DG3-IMB-04,CH0=XCS:DG3:IMB:04:CH0,CH1=XCS:DG3:IMB:04:CH1,CH2=XCS:DG3:IMB:04:CH2,CH3=XCS:DG3:IMB:04:CH3")
dbLoadRecords( "db/ipimb.db, "RECNAME=HFX:DG3:IMB:01,BOX=HFX-DG3-IMB-01,CH0=HFX:DG3:IMB:01:CH0,CH1=HFX:DG3:IMB:01:CH1,CH2=HFX:DG3:IMB:01:CH2,CH3=HFX:DG3:IMB:01:CH3")
dbLoadRecords( "db/ipimb.db, "RECNAME=HFX:DG3:IMB:02,BOX=HFX-DG3-IMB-02,CH0=HFX:DG3:IMB:02:CH0,CH1=HFX:DG3:IMB:02:CH1,CH2=HFX:DG3:IMB:02:CH2,CH3=HFX:DG3:IMB:02:CH3")
